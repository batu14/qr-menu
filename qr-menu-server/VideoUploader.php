...
class VideoUploader {
    ...
    public function __construct($targetDir = "uploads/videos", $maxSize = 100 * 1024 * 1024, $allowedTypes = ["mp4", "avi", "mov", "webm", "mkv"],$mkdir = false) {
    ...
    public function upload($file, $name = null) {
        ...
        $newFileName = $name ? $name . '.' . $fileExt : uniqid() . '.' . $fileExt; // Benzersiz bir dosya adı oluştur
    ...
    // Birden fazla video dosyasını yüklemek için yeni fonksiyon
